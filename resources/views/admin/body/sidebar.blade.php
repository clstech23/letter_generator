 ...
 <aside class="main-sidebar">
    ...
    <section class="sidebar">	
        ...
        <div class="user-profile">
            ...
            <img src="{{asset('backend/images/logo.png')}}" alt="" style="width: 280px;height: 70px; margin-top: -10px;}">
					 </div>
				</a>
			</div>
        </div>
...
<li class="treeview {{ ($prefix == '/students')?'active':'' }}">
          <a href="#">
             <i data-feather="hard-drive"></i></i> <span>Letter Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
        ...
        <!--li><a href="{{ route('letter.view') }}"><i class="ti-more"></i>View Letter</a></li>
         <li><a href="{{ route('add.letter') }}"><i class="ti-more"></i>Add Letter</a></li-->
